...
public class Face_Dection_Mark_Atten extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_dection_mark_atten);
        ...
        imgCamera = findViewById(R.id.Camera_img);
        Button btnCamera = findViewById(R.id.Click_btn);
        ...
        Back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Face_Dection_Mark_Atten.this, Mark_Atten.class);
        ...
        Location_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    if(ActivityCompat.checkSelfPermission(Face_Dection_Mark_Atten.this, ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) // checks if the gps is on or not
                    {
                        if(isGPSEnable())
                        {
                            LocationServices.getFusedLocationProviderClient(Face_Dection_Mark_Atten.this).requestLocationUpdates(locationRequest, new LocationCallback() {
                                @Override
                                public void onLocationResult(@NonNull LocationResult locationResult) {
                                    super.onLocationResult(locationResult);
                                    LocationServices.getFusedLocationProviderClient(Face_Dection_Mark_Atten.this).removeLocationUpdates(this);
                                    ...
                                    if(locationResult != null && locationResult.getLocations().size() > 0)
                                    {
                                        ...
                                        if(latitude >= 28.6812700 && latitude < 28.6813500  && longitude >= 77.3766800 && longitude < 77.3767500)
                                        {
                                            ...
                                            Toast.makeText(Face_Dection_Mark_Atten.this, "LONGITUDE : " + Longitude + "\nLATITUDE : " + Latitude,Toast.LENGTH_LONG);
                                        }
        ...
        Mark_Atten.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "ENTER YOUR Name!!", Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (TextUtils.isEmpty(Enrollment_no))
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "ENTER YOUR ENROLLMENT NUM!!", Toast.LENGTH_SHORT).show();
                    return;
                }

                else if (TextUtils.isEmpty(Subject))
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "ENTER YOUR SUBJECT!!", Toast.LENGTH_SHORT).show();
                    return;
                }

                else if (TextUtils.isEmpty(Date))
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "ENTER YOUR DATE!!", Toast.LENGTH_SHORT).show();
                    return;
                }

                else if (TextUtils.isEmpty(Location))
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "ENTER YOUR LOCATION!!", Toast.LENGTH_SHORT).show();
                    return;
                }
               ...
               /* else if(Location.equalsIgnoreCase("You Are Not In Class"))
                ...
                {
                    Intent intent = new Intent(Face_Dection_Mark_Atten.this, Attendance_Marked_Sucess.class);
                    startActivity(intent);
                }

                else
                {
                    Toast.makeText(Face_Dection_Mark_Atten.this, "WRONG CREDENTIALS ENTERED ATTENDANCE MARKED FAILED!!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Face_Dection_Mark_Atten.this, Attendence_Marked_Fail.class);
                    startActivity(intent);
                }
            }
        });
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                try {
                    ...
                    Toast.makeText(Face_Dection_Mark_Atten.this, "GPS is On!!", Toast.LENGTH_LONG).show();
                    ...
                    switch (e.getStatusCode())
                    {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED : //location setting status code used to get the location setting status(wether its turn on, or the device have location access or not etc)
                            ...
                            try
                            {
                                ...
                                resolvableApiException.startResolutionForResult(Face_Dection_Mark_Atten.this, REQUEST_CHECK_SETTING);
                            }
